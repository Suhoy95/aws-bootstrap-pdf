...
[Документация Amazon](https://docs.aws.amazon.com/lambda/latest/dg/welcome.html)

# Создание lambda-функции

![qwe](../img/lambda-creating.png)

# Тестирование и отладка lambda-функции

![qwe](../img/lambda-test.png)

![qwe](../img/lambda-designer.png)

# Редактирование lambda-функции

![qwe](../img/lambda-testing.png)

![qwe](../img/lambda-role.png)